---- MODULE ubcc_transport_faults_TTrace_1782153878 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ubcc_transport_faults_TTrace_1782153878.json", _TETrace)
...
\*
\*trace == IODeserialize("ubcc_transport_faults_TTrace_1782153878.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ubcc_transport_faults_TTrace_1782153878 ----
CONSTANTS
    Nodes = { 0 , 1 , 2 }
    MaxEpoch = 4
    TombstoneWindow = 10
