---- MODULE ubcc_protocol_TTrace_1782153877 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ubcc_protocol_TTrace_1782153877.json", _TETrace)
...
\*
\*trace == IODeserialize("ubcc_protocol_TTrace_1782153877.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([ostTargetMask |-> {},ostReservedEpoch |-> 1,tombstone |-> (<<0, 0>> :> FALSE @@ <<0, 1>> :> FALSE @@ <<0, 2>> :> FALSE @@ <<0, 3>> :> FALSE @@ <<0, 4>> :> FALSE @@ <<1, 0>> :> FALSE @@ <<1, 1>> :> FALSE @@ <<1, 2>> :> FALSE @@ <<1, 3>> :> FALSE @@ <<1, 4>> :> FALSE @@ <<2, 0>> :> FALSE @@ <<2, 1>> :> FALSE @@ <<2, 2>> :> FALSE @@ <<2, 3>> :> FALSE @@ <<2, 4>> :> FALSE @@ <<3, 0>> :> FALSE @@ <<3, 1>> :> FALSE @@ <<3, 2>> :> FALSE @@ <<3, 3>> :> FALSE @@ <<3, 4>> :> FALSE @@ <<4, 0>> :> FALSE @@ <<4, 1>> :> FALSE @@ <<4, 2>> :> FALSE @@ <<4, 3>> :> FALSE @@ <<4, 4>> :> FALSE),ostAccepted |-> FALSE,ostStage |-> "WAITING_CLEAR",ostIntendedSharers |-> {1},tick |-> 0,ostOpType |-> "GRANT_HANDSHAKE",committedSharers |-> {},ostIntendedState |-> "G_S",ostAckMask |-> {},ostBaseEpoch |-> 0,committedEpoch |-> 0,ostRecallDone |-> FALSE,committedState |-> "G_I",commitLog |-> <<>>,ostRequester |-> 1,committedOwner |-> -1,committedDirty |-> FALSE,ostIntendedOwner |-> -1,ostInvalidateDone |-> FALSE,ostReqId |-> 0]),
    ([ostTargetMask |-> {},ostReservedEpoch |-> 1,tombstone |-> (<<0, 0>> :> FALSE @@ <<0, 1>> :> FALSE @@ <<0, 2>> :> FALSE @@ <<0, 3>> :> FALSE @@ <<0, 4>> :> FALSE @@ <<1, 0>> :> TRUE @@ <<1, 1>> :> FALSE @@ <<1, 2>> :> FALSE @@ <<1, 3>> :> FALSE @@ <<1, 4>> :> FALSE @@ <<2, 0>> :> FALSE @@ <<2, 1>> :> FALSE @@ <<2, 2>> :> FALSE @@ <<2, 3>> :> FALSE @@ <<2, 4>> :> FALSE @@ <<3, 0>> :> FALSE @@ <<3, 1>> :> FALSE @@ <<3, 2>> :> FALSE @@ <<3, 3>> :> FALSE @@ <<3, 4>> :> FALSE @@ <<4, 0>> :> FALSE @@ <<4, 1>> :> FALSE @@ <<4, 2>> :> FALSE @@ <<4, 3>> :> FALSE @@ <<4, 4>> :> FALSE),ostAccepted |-> FALSE,ostStage |-> "DONE",ostIntendedSharers |-> {1},tick |-> 0,ostOpType |-> "NONE",committedSharers |-> {1},ostIntendedState |-> "G_S",ostAckMask |-> {},ostBaseEpoch |-> 0,committedEpoch |-> 1,ostRecallDone |-> FALSE,committedState |-> "G_S",commitLog |-> <<<<1, 0>>>>,ostRequester |-> 1,committedOwner |-> -1,committedDirty |-> FALSE,ostIntendedOwner |-> -1,ostInvalidateDone |-> FALSE,ostReqId |-> 0]),
    ([ostTargetMask |-> {1},ostReservedEpoch |-> 2,tombstone |-> (<<0, 0>> :> FALSE @@ <<0, 1>> :> FALSE @@ <<0, 2>> :> FALSE @@ <<0, 3>> :> FALSE @@ <<0, 4>> :> FALSE @@ <<1, 0>> :> TRUE @@ <<1, 1>> :> FALSE @@ <<1, 2>> :> FALSE @@ <<1, 3>> :> FALSE @@ <<1, 4>> :> FALSE @@ <<2, 0>> :> FALSE @@ <<2, 1>> :> FALSE @@ <<2, 2>> :> FALSE @@ <<2, 3>> :> FALSE @@ <<2, 4>> :> FALSE @@ <<3, 0>> :> FALSE @@ <<3, 1>> :> FALSE @@ <<3, 2>> :> FALSE @@ <<3, 3>> :> FALSE @@ <<3, 4>> :> FALSE @@ <<4, 0>> :> FALSE @@ <<4, 1>> :> FALSE @@ <<4, 2>> :> FALSE @@ <<4, 3>> :> FALSE @@ <<4, 4>> :> FALSE),ostAccepted |-> FALSE,ostStage |-> "WAITING_ALL_ACKS",ostIntendedSharers |-> {0},tick |-> 0,ostOpType |-> "INVALIDATE",committedSharers |-> {1},ostIntendedState |-> "G_E",ostAckMask |-> {},ostBaseEpoch |-> 0,committedEpoch |-> 1,ostRecallDone |-> FALSE,committedState |-> "G_S",commitLog |-> <<<<1, 0>>>>,ostRequester |-> 0,committedOwner |-> -1,committedDirty |-> FALSE,ostIntendedOwner |-> 0,ostInvalidateDone |-> FALSE,ostReqId |-> 0]),
    ([ostTargetMask |-> {1},ostReservedEpoch |-> 2,tombstone |-> (<<0, 0>> :> FALSE @@ <<0, 1>> :> FALSE @@ <<0, 2>> :> FALSE @@ <<0, 3>> :> FALSE @@ <<0, 4>> :> FALSE @@ <<1, 0>> :> TRUE @@ <<1, 1>> :> FALSE @@ <<1, 2>> :> FALSE @@ <<1, 3>> :> FALSE @@ <<1, 4>> :> FALSE @@ <<2, 0>> :> FALSE @@ <<2, 1>> :> FALSE @@ <<2, 2>> :> FALSE @@ <<2, 3>> :> FALSE @@ <<2, 4>> :> FALSE @@ <<3, 0>> :> FALSE @@ <<3, 1>> :> FALSE @@ <<3, 2>> :> FALSE @@ <<3, 3>> :> FALSE @@ <<3, 4>> :> FALSE @@ <<4, 0>> :> FALSE @@ <<4, 1>> :> FALSE @@ <<4, 2>> :> FALSE @@ <<4, 3>> :> FALSE @@ <<4, 4>> :> FALSE),ostAccepted |-> FALSE,ostStage |-> "WAITING_CLEAR",ostIntendedSharers |-> {0},tick |-> 0,ostOpType |-> "GRANT_HANDSHAKE",committedSharers |-> {},ostIntendedState |-> "G_E",ostAckMask |-> {1},ostBaseEpoch |-> 0,committedEpoch |-> 1,ostRecallDone |-> FALSE,committedState |-> "G_S",commitLog |-> <<<<1, 0>>>>,ostRequester |-> 0,committedOwner |-> -1,committedDirty |-> FALSE,ostIntendedOwner |-> 0,ostInvalidateDone |-> TRUE,ostReqId |-> 0])
    >>
----
...
---- CONFIG ubcc_protocol_TTrace_1782153877 ----
CONSTANTS
    Nodes = { 0 , 1 , 2 }
    MaxEpoch = 4
    TombstoneWindow = 10
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jun 23 02:44:38 CST 2026