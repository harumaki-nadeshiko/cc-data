---- MODULE ubcc_transport_faults_TTrace_1782153869 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ubcc_transport_faults_TTrace_1782153869.json", _TETrace)
...
\*
\*trace == IODeserialize("ubcc_transport_faults_TTrace_1782153869.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ubcc_transport_faults_TTrace_1782153869 ----
CONSTANTS
    Nodes = { 0 , 1 , 2 }
    MaxEpoch = 4
    TombstoneWindow = 10
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jun 23 02:44:30 CST 2026