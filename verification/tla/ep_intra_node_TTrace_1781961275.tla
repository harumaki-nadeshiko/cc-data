---- MODULE ep_intra_node_TTrace_1781961275 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ep_intra_node_TTrace_1781961275.json", _TETrace)
...
\*
\*trace == IODeserialize("ep_intra_node_TTrace_1781961275.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ep_intra_node_TTrace_1781961275 ----
CONSTANTS
    Nodes = { 0 }
    MaxTxn = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jun 20 21:14:35 CST 2026