---- MODULE ep_intra_node_dual_TTrace_1781969348 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ep_intra_node_dual_TTrace_1781969348.json", _TETrace)
...
\*
\*trace == IODeserialize("ep_intra_node_dual_TTrace_1781969348.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ep_intra_node_dual_TTrace_1781969348 ----
CONSTANTS
    NumCPUs = 2
    MaxDataVersion = 1
    NumSockets = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jun 20 23:29:09 CST 2026