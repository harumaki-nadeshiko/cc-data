...
static_assert(sizeof(UBWritebackReqBody) == 96);
static_assert(offsetof(UBWritebackReqBody, parentInvalidateReqId) == 80);
static_assert(offsetof(UBWritebackReqBody, parentInvalidateEpoch) == 88);
...
static_assert(sizeof(UBHAPermissionRespBody) == 88);
static_assert(offsetof(UBHAPermissionRespBody, leaseId) == 80);
...
static_assert(sizeof(UBWritebackRespBody) == 16);
static_assert(offsetof(UBWritebackRespBody, mergedRecallReqId) == 8);
