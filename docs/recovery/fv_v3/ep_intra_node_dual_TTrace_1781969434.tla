---- MODULE ep_intra_node_dual_TTrace_1781969434 ----
...
_inv ==
    ~(
        ...
        /\
        rnfCompAckSent = ((0 :> FALSE @@ 1 :> TRUE))
        /\
        cpuData = ((0 :> 0 @@ 1 :> 0))
        /\
        snfState = ((0 :> "IDLE" @@ 1 :> "IDLE"))
        /\
        rnfState = ((0 :> "IDLE" @@ 1 :> "PENDING_CU"))
        /\
        hnfData = ((0 :> 0 @@ 1 :> 0))
        /\
        rspQ = ((0 :> <<>> @@ 1 :> <<>>))
        ...
        /\
        rnfCallbackArmed = ((0 :> FALSE @@ 1 :> TRUE))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ep_intra_node_dual_TTrace_1781969434.json", _TETrace)
...
\*
\*trace == IODeserialize("ep_intra_node_dual_TTrace_1781969434.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG ep_intra_node_dual_TTrace_1781969434 ----
CONSTANTS
    NumCPUs = 2
    MaxDataVersion = 1
    NumSockets = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jun 20 23:30:37 CST 2026