---- MODULE ep_intra_node_dual_TTrace_1781969375 ----
...
_inv ==
    ~(
        ...
        /\
        interSocketQ = (<<[kind |-> "REMOTE_REQ", data |-> 0, srcSock |-> 1, dstSock |-> 0, cpu |-> 1, op |-> "RS", lat |-> 1]>>)
        /\
        dramData = ((0 :> 0 @@ 1 :> 0))
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("ep_intra_node_dual_TTrace_1781969375.json", _TETrace)
...
\*
\*trace == IODeserialize("ep_intra_node_dual_TTrace_1781969375.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([cpuTargetSock |-> (0 :> 0 @@ 1 :> 0),hnfTbeGrantData |-> (0 :> 0 @@ 1 :> 0),reqQ |-> (0 :> <<>> @@ 1 :> <<>>),hnfTbeRequester |-> (0 :> 0 @@ 1 :> -1),hnfTbeValid |-> (0 :> TRUE @@ 1 :> FALSE),backendState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),snpQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingKind |-> (0 :> "RS" @@ 1 :> "RS"),rnfCompAckSent |-> (0 :> FALSE @@ 1 :> FALSE),cpuData |-> (0 :> 0 @@ 1 :> 0),snfState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),rnfState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),hnfData |-> (0 :> 0 @@ 1 :> 0),rspQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingData |-> (0 :> 0 @@ 1 :> 0),dramWritten |-> (0 :> FALSE @@ 1 :> FALSE),interSocketQ |-> <<[kind |-> "REMOTE_GRANT", data |-> 0, srcSock |-> 0, dstSock |-> 1, cpu |-> 1, op |-> "RU", lat |-> 0], [kind |-> "REMOTE_REQ", data |-> 0, srcSock |-> 1, dstSock |-> 0, cpu |-> 1, op |-> "RS", lat |-> 1]>>,dramData |-> (0 :> 0 @@ 1 :> 0),hnfPendingOwnerUpdate |-> (0 :> FALSE @@ 1 :> FALSE),hnfState |-> (0 :> "I" @@ 1 :> "I"),rnfCompUCSeen |-> (0 :> FALSE @@ 1 :> FALSE),backendGrantData |-> (0 :> 0 @@ 1 :> 0),latestGlobalWrite |-> 0,hnfCacheLine |-> (0 :> FALSE @@ 1 :> FALSE),datQ |-> (0 :> <<>> @@ 1 :> <<>>),hnfOwner |-> (0 :> -1 @@ 1 :> -1),cpuState |-> (0 :> "P_RS" @@ 1 :> "P_RS"),hnfTbeNeedData |-> (0 :> TRUE @@ 1 :> FALSE),rnfCallbackArmed |-> (0 :> FALSE @@ 1 :> FALSE),hnfTbePhase |-> (0 :> "WAIT_SNF" @@ 1 :> "NONE"),hnfTbeOp |-> (0 :> "RS" @@ 1 :> "NONE"),hnfSharers |-> (0 :> {} @@ 1 :> {})]),
    ([cpuTargetSock |-> (0 :> 0 @@ 1 :> 0),hnfTbeGrantData |-> (0 :> 0 @@ 1 :> 0),reqQ |-> (0 :> <<>> @@ 1 :> <<>>),hnfTbeRequester |-> (0 :> 0 @@ 1 :> -1),hnfTbeValid |-> (0 :> TRUE @@ 1 :> FALSE),backendState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),snpQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingKind |-> (0 :> "RS" @@ 1 :> "RS"),rnfCompAckSent |-> (0 :> FALSE @@ 1 :> FALSE),cpuData |-> (0 :> 0 @@ 1 :> 0),snfState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),rnfState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),hnfData |-> (0 :> 0 @@ 1 :> 0),rspQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingData |-> (0 :> 0 @@ 1 :> 0),dramWritten |-> (0 :> FALSE @@ 1 :> FALSE),interSocketQ |-> <<[kind |-> "REMOTE_REQ", data |-> 0, srcSock |-> 1, dstSock |-> 0, cpu |-> 1, op |-> "RS", lat |-> 1]>>,dramData |-> (0 :> 0 @@ 1 :> 0),hnfPendingOwnerUpdate |-> (0 :> FALSE @@ 1 :> FALSE),hnfState |-> (0 :> "I" @@ 1 :> "I"),rnfCompUCSeen |-> (0 :> FALSE @@ 1 :> FALSE),backendGrantData |-> (0 :> 0 @@ 1 :> 0),latestGlobalWrite |-> 0,hnfCacheLine |-> (0 :> FALSE @@ 1 :> FALSE),datQ |-> (0 :> <<>> @@ 1 :> <<[kind |-> "CPU_GRANT", dst |-> 1, data |-> 0, srcSock |-> 0]>>),hnfOwner |-> (0 :> -1 @@ 1 :> -1),cpuState |-> (0 :> "P_RS" @@ 1 :> "P_RS"),hnfTbeNeedData |-> (0 :> TRUE @@ 1 :> FALSE),rnfCallbackArmed |-> (0 :> FALSE @@ 1 :> FALSE),hnfTbePhase |-> (0 :> "WAIT_SNF" @@ 1 :> "NONE"),hnfTbeOp |-> (0 :> "RS" @@ 1 :> "NONE"),hnfSharers |-> (0 :> {} @@ 1 :> {})]),
    ([cpuTargetSock |-> (0 :> 0 @@ 1 :> 0),hnfTbeGrantData |-> (0 :> 0 @@ 1 :> 0),reqQ |-> (0 :> <<>> @@ 1 :> <<>>),hnfTbeRequester |-> (0 :> 0 @@ 1 :> -1),hnfTbeValid |-> (0 :> TRUE @@ 1 :> FALSE),backendState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),snpQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingKind |-> (0 :> "RS" @@ 1 :> "NONE"),rnfCompAckSent |-> (0 :> FALSE @@ 1 :> FALSE),cpuData |-> (0 :> 0 @@ 1 :> 0),snfState |-> (0 :> "IDLE" @@ 1 :> "IDLE"),rnfState |-> (0 :> "IDLE" @@ 1 :> "HAVE_SC"),hnfData |-> (0 :> 0 @@ 1 :> 0),rspQ |-> (0 :> <<>> @@ 1 :> <<>>),cpuPendingData |-> (0 :> 0 @@ 1 :> 0),dramWritten |-> (0 :> FALSE @@ 1 :> FALSE),interSocketQ |-> <<[kind |-> "REMOTE_REQ", data |-> 0, srcSock |-> 1, dstSock |-> 0, cpu |-> 1, op |-> "RS", lat |-> 1]>>,dramData |-> (0 :> 0 @@ 1 :> 0),hnfPendingOwnerUpdate |-> (0 :> FALSE @@ 1 :> FALSE),hnfState |-> (0 :> "I" @@ 1 :> "I"),rnfCompUCSeen |-> (0 :> FALSE @@ 1 :> FALSE),backendGrantData |-> (0 :> 0 @@ 1 :> 0),latestGlobalWrite |-> 0,hnfCacheLine |-> (0 :> FALSE @@ 1 :> FALSE),datQ |-> (0 :> <<>> @@ 1 :> <<>>),hnfOwner |-> (0 :> -1 @@ 1 :> -1),cpuState |-> (0 :> "P_RS" @@ 1 :> "SC"),hnfTbeNeedData |-> (0 :> TRUE @@ 1 :> FALSE),rnfCallbackArmed |-> (0 :> FALSE @@ 1 :> FALSE),hnfTbePhase |-> (0 :> "WAIT_SNF" @@ 1 :> "NONE"),hnfTbeOp |-> (0 :> "RS" @@ 1 :> "NONE"),hnfSharers |-> (0 :> {} @@ 1 :> {})])
    >>
----
...
---- CONFIG ep_intra_node_dual_TTrace_1781969375 ----
CONSTANTS
    NumCPUs = 2
    MaxDataVersion = 1
    NumSockets = 2
...
ALIAS
    _expression
=============================================================================
\* Generated on Sat Jun 20 23:29:36 CST 2026