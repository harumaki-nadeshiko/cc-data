 ...
 *
 * This is the CORE module: types, helpers, BaseInit, BaseNext, invariants.
 * Top-level modules (ubcc_protocol, ubcc_transport_faults) extend this
 * and define their own Init, Next, Spec.
 *)
...
(***************************************************************************)
(* Next-state relation (BaseNext - used by top-level modules)                *)
(***************************************************************************)
