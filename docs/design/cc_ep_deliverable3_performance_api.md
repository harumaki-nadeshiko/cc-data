...
| 指标 | 验收门槛 | 最终结果 | 结论 |
|---|---:|---:|---|
| 指标 1：等效追踪容量 | ≥ 1.5× | 1.515091× | 通过 |
| 指标 1：附加时延 | < 50 cycles | -1635.994219 cycles | 通过 |
| 指标 2：适用场景等权平均降幅 | ≥ 10% | 64.759276% | 通过 |
...
|---|---:|---:|---:|
| 等效追踪条目 | 65,536 | 99,293 | 1.515091× |
| guest 平均时延 | 899.031875 ns/op | 81.034765 ns/op | -817.997109 ns/op |
| 2 GHz 周期差 | — | — | -1635.994219 cycles |

### 3.2 结果解释

spill-noopt 的等效追踪容量达到 naive 的 1.515091 倍，超过 1.5 倍门槛。容量扩展由
ResidentDir 与 Backstore 的分层管理实现，热点元数据保留在 SRAM 路径，冷元数据进入
后备存储。

压力后的 guest 平均时延没有增加，spill-noopt 比 naive 低 817.997109 ns/op。该结果说明
...
|---|---:|---:|---:|
| TC135 preserved sharer revisit | 2344.449361 | 39.736430 | 98.305085% |
| TC136 preserved owner store | 2384.185791 | 79.472860 | 96.666667% |
| TC137 new requester load | 2384.185791 | 1788.139343 | 25.000000% |
| TC138 dirty owner handoff | 2384.185791 | 2702.077230 | -13.333333% |
| TC139 mixed batch | 23563.702901 | 635.782878 | 97.301855% |
| TC217 catalog batch | 4132.588704 | 635.782878 | 84.615385% |

TC140 的 naive 均值为 119.209290 ns，低于 500 ns 适用门槛，因此作为低时延中性控制项，
不进入指标 2 聚合。
...
指标 2 的适用场景等权平均降幅为 64.759276%，超过 10% 合同门槛。
...
|---|---|---:|---:|---:|
| TC142 | OLTP buffer pool | 5200.313656 | 4437.245176 | 14.673509% |
| TC143 | B-tree traversal | 3051.768241 | 2267.770469 | 25.689951% |
| TC144 | WAL/checkpoint | 5294.066796 | 4400.848411 | 16.872065% |
| TC145 | FaaS warm invocation | 2886.168659 | 2291.965454 | 20.587958% |
| TC146 | Graph frontier | 3184.057277 | 2266.780939 | 28.808412% |
| TC147 | Feature store | 2892.318056 | 2321.670763 | 19.729756% |
...
![图 5-1 UBCC 与 HA-VI 聚合时延对比](figures/ubcc-ha-vi-comparison.png)

| L3 压力 | 场景组 | UBCC ticks/op | HA-VI ticks/op | UBCC 降幅 |
|---:|---|---:|---:|---:|
| 100% | 核心场景组 | 31.439583 | 39.343750 | 20.090019% |
| 100% | 代表场景组 | 76.177500 | 79.059583 | 3.645457% |
| 150% | 核心场景组 | 31.406250 | 39.345833 | 20.178969% |
| 150% | 代表场景组 | 76.194622 | 79.073138 | 3.640320% |
...
实现 1.515091 倍等效追踪容量，optimized profile 在适用场景中取得 64.759276% 等权平均
