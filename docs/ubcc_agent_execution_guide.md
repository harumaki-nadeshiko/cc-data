...
本文档用于指导后续 Agent 分阶段完成 gem5 Ruby CHI + UBCC 原型。总方案见 `gem5_chi_ubcc_plan.md`；本文只保留执行边界、阶段目标、输入输出和验收条件。
...
## 2. Phase M1：Single Node Clustered CHI
...
## 3. Phase M2：Logical Domain Isolation
...
## 4. Phase M3：EP-RNF/EP-SNF Skeleton
...
## 5. Phase M4：Sentinel Registration
...
## 6. Phase M5：DSM Remote First Miss Bring-up
...
## 7. Phase M6：UBCC Directory And EP-RNF Local Access
...
## 8. Phase M7：Writeback, Evict, Owner Transfer
...
## 9. Phase M8：GrantS And Read-Sharing Recovery
...
## 10. Phase M9：Metadata And Multi-gem5 Preparation
